...
public class Abonne {
    ...
    public Abonne(String nom, String prenom, String email, LocalDate dateInscription) throws SaisieException {
        this.setNom(nom);
        this.setPrenom(prenom);
        this.setEmail(email);
        this.dateInscription = dateInscription;
    }
    public ArrayList<Abonne> getListeAbonnés(){
        return listeAbonnes;
    }

    public void setListeAbonnés(ArrayList<Abonne> listeAbonnes) {
